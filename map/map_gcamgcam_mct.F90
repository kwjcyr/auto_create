module map_gcamgcam_mct

!---------------------------------------------------------------------
!
! Purpose:
!
! Collect coupling routines for sequential coupling of gcamx - gcama
!       
! Author: T. Craig
!
!---------------------------------------------------------------------
...
!--------------------------------------------------------------------------
  ...
  public :: map_gcam2gcam_init_mct
  public :: map_gcamx2gcamg_mct
  public :: map_gcamg2gcamx_mct

  ! Note ccc is component, xxx is driver/coupler

  interface map_gcam2gcam_init_mct; module procedure &
    map_ccc2ccc_init_mct
  end interface
  interface map_gcamx2gcamg_mct; module procedure &
    map_xxx2ccc_mct
  end interface
  interface map_gcamg2gcamx_mct; module procedure &
    map_ccc2xxx_mct
  end interface
...
!--------------------------------------------------------------------------
  ...
  character(*),parameter :: subName = '(map_gcamgcam_mct)'
...
!=======================================================================
  ...
  subroutine map_ccc2ccc_init_mct( cdata_cc, x2c_cc, c2x_cc, ID_cc, &
    ...
    ! Local Variables
    !
    character(len=*),parameter :: subname = "(map_gcam2gcam_init_mct) "
...
!=======================================================================
  ...
  subroutine map_ccc2xxx_mct( cdata_cc, av_cc, cdata_cx, av_cx, fldlist )
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_gcamg2gcamx_mct) "
...
!=======================================================================
  ...
  subroutine map_xxx2ccc_mct( cdata_cx, av_cx, cdata_cc, av_cc, fldlist)
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_gcamx2gcamg_mct) "
