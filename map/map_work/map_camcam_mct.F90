...
! Purpose:
!
! Collect coupling routines for sequential coupling of camx - cama
!       
! Author: T. Craig
!
!---------------------------------------------------------------------
...
!--------------------------------------------------------------------------
  ...
  public :: map_camx2camc_mct
  public :: map_camc2camx_mct
  ...
  interface map_camx2camc_mct; module procedure &
    map_xxx2ccc_mct
  end interface
  interface map_camc2camx_mct; module procedure &
    map_ccc2xxx_mct
  end interface
...
!=======================================================================
  ...
  subroutine map_ccc2xxx_mct( cdata_cc, av_cc, cdata_cx, av_cx, fldlist )
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_camc2camx_mct) "
...
!=======================================================================
  ...
  subroutine map_xxx2ccc_mct( cdata_cx, av_cx, cdata_cc, av_cc, fldlist)
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_camx2camc_mct) "
