...
! Purpose:
!
! Collect coupling routines for sequential coupling of geax - geaa
!       
! Author: T. Craig
!
!---------------------------------------------------------------------
...
!--------------------------------------------------------------------------
  ...
  public :: map_geax2geag_mct
  public :: map_geag2geax_mct
  ...
  interface map_geax2geag_mct; module procedure &
    map_xxx2ccc_mct
  end interface
  interface map_geag2geax_mct; module procedure &
    map_ccc2xxx_mct
  end interface
...
!=======================================================================
  ...
  subroutine map_ccc2xxx_mct( cdata_cc, av_cc, cdata_cx, av_cx, fldlist )
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_geag2geax_mct) "
...
!=======================================================================
  ...
  subroutine map_xxx2ccc_mct( cdata_cx, av_cx, cdata_cc, av_cc, fldlist)
    ...
    !-----------------------------------------------------
    character(len=*),parameter :: subname = "(map_geax2geag_mct) "
