...
!{list} key="attr_c2x"  
!   index_{c}2x_{attr_c2x}  = mct_avect_indexra({c}2x,'{attr_c2x}')
...
!   index_x2{c}_{attr_x2c}  = mct_avect_indexra(x2{c},'{attr_x2c}')
  ...
  end subroutine {cccmodule}_CplIndicesSet

end module {cccmodule}_CplIndices
